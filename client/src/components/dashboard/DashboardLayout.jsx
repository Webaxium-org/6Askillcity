...
const TYPE_STYLES = {
  application_submitted: { border: "border-l-blue-500", dot: "bg-blue-500", icon: FileText, iconClass: "text-blue-500" },
  application_approved:  { border: "border-l-emerald-500", dot: "bg-emerald-500", icon: Check, iconClass: "text-emerald-500" },
  application_rejected:  { border: "border-l-rose-500", dot: "bg-rose-500", icon: X, iconClass: "text-rose-500" },
  payment_completed:     { border: "border-l-emerald-500", dot: "bg-emerald-500", icon: CreditCard, iconClass: "text-emerald-500" },
  payment_due:           { border: "border-l-amber-500", dot: "bg-amber-500", icon: CreditCard, iconClass: "text-amber-500" },
  new_ticket:            { border: "border-l-amber-500", dot: "bg-amber-500", icon: MessageSquare, iconClass: "text-amber-500" },
  ticket_status_updated: { border: "border-l-violet-500", dot: "bg-violet-500", icon: MessageSquare, iconClass: "text-violet-500" },
  default:               { border: "border-l-primary", dot: "bg-primary", icon: Bell, iconClass: "text-primary" },
};
                            ...
                            return (
                              ...
                              >
                                <div className="flex items-start gap-2.5 pr-6">
                                  <div className={cn("mt-0.5 shrink-0 w-7 h-7 rounded-lg flex items-center justify-center", notif.isRead ? "bg-muted" : "bg-primary/10")}>
                                    <IconComp className={cn("w-3.5 h-3.5", style.iconClass)} />
                                  </div>
                                  ...
                                  {!notif.isRead && (
                                    <div className={cn("shrink-0 w-1.5 h-1.5 rounded-full mt-1.5", style.dot)} />
                                  )}
                                </div>
                                <button
