...
import { getMyProfile as getPartnerProfile } from "../../api/partner.api";
...
export default function MyProfile() {
  ...
  const profile = isPartner ? data.partner : data;
  const permissions = isPartner ? data.permissions : [];
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-8">
                  <div className="space-y-1">
                    ...
                    <p className="font-semibold text-lg">
                      {isPartner ? profile.licenseeName : profile.fullName}
                    </p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">
                    ...
                    <p className="font-semibold flex items-center gap-2">
                      ...
                      {isPartner ? profile.licenseeEmail : profile.email}
                    </p>
                  </div>
                  <div className="space-y-1">
                    <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">
                ...
                <div className="pt-8 border-t border-border">
                  ...
                  <div className="space-y-4">
                    <div className="space-y-1">
                      ...
                      <p className="font-semibold">{profile.location.address}</p>
                    </div>
                    <div className="grid grid-cols-2 lg:grid-cols-4 gap-4">
                      <div className="space-y-1">
                        ...
                        <p className="font-semibold">{profile.location.city}</p>
                      </div>
                      <div className="space-y-1">
                        <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">
                          State
                        </p>
                        <p className="font-semibold">{profile.location.state}</p>
                      </div>
                      <div className="space-y-1">
                        <p className="text-xs font-bold text-muted-foreground uppercase tracking-widest">
                          Pincode
